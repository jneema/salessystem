...
conn = psycopg2.connect("dbname='dmdaq6d4bpduf' user='wfneytknjtppcs' host='ec2-52-212-228-71.eu-west-1.compute.amazonaws.com' password='f27fbbd407eed96a5dcfee57882a0f6acef6a08398e9b48fcb80b70f7e2884f6' port='5432'")
cur = conn.cursor
@app.route('/')
def home():
